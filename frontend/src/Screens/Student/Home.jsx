...
const Home = () => {
  ...
  const getMenuItemClass = (menuId) => {
    ...
    return `
      ...
      ${isSelected ? "bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-lg transform -translate-y-0.5" 
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
        ...
        {/* Content Area */}
        <div className="bg-gray-50 rounded-xl shadow-sm p-6 sm:p-8 min-h-[60vh] transition-all">
          {renderContent()}
        </div>
      </div>
