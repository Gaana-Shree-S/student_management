  ...
  return (
    <div className="w-full mx-auto mt-10 flex flex-col mb-12 px-6 md:px-10">
      <div className="flex justify-between items-center mb-6">
        ...
        >
          <IoMdAdd className="text-lg" /> Add Admin
        </CustomButton>
      </div>
      ...
      {showAddForm && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 p-8 w-[90%] max-w-4xl max-h-[90vh] overflow-y-auto relative">
            <button
              onClick={resetForm}
              className="absolute top-4 right-4 text-gray-500 hover:text-gray-800 dark:hover:text-gray-200 p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition"
            >
              <IoMdClose className="text-2xl" />
            </button>

            <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-6 tracking-tight">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white/90 dark:bg-gray-800/70"
                    accept="image/*"
                  />
                </div>

                {/* Repeated fields (unchanged logic, just style) */}
                {[
                  ...
                  <div key={field.id}>
                    <label className="block text-sm font-medium text-white-700 dark:text-gray-300 mb-1">
                      {field.label}
                    </label>
                    <input
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {[
                    ...
                    <div key={f.id}>
                      ...
                      <input
                        type={f.type || "text"}
                        value={data.emergencyContact[f.id]}
                        onChange={(e) =>
                          handleEmergencyContactChange(f.id, e.target.value)
                        }
                        className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 bg-white/90 dark:bg-gray-800/70"
                      />
                    </div>
      ...
      {dataLoading ? (
        ...
        !showAddForm && (
          <div className="overflow-x-auto rounded-2xl shadow-lg bg-white/70 backdrop-blur-md border border-gray-200 mt-8">
              ...
              <tbody>
                {admins && admins.length > 0 ? (
                  ...
                  <tr>
                    <td
                      colSpan="6"
                      className="text-center text-base py-10 text-gray-600"
                    >
                      No Admins found.
                    </td>
                  </tr>
